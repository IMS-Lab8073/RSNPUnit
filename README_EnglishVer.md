...
- [1. Connect to the Unit](#1-connect-to-the-unit-1)
  - [1.1 Connect to the Unit and PC](#11-connect-to-the-unit-and-pc-1)
  - [1.2 Connect to the Unit](#12-connect-to-the-unit-1)
- [2. Set up the Unit](#2-set-up-the-unit-1)
  - [2.1 Connect to Wireless LAN](#21-connect-to-wireless-lan-1)
  - [2.2 Set up the file of RSNP properties](#22-set-up-the-file-of-rsnp-properties-1)
- [3. Run action of the RSNP Unit](#3-run-action-of-the-rsnp-unit-1)
  - [3.1 Execution of RSNP communication program](#31-execution-of-rsnp-communication-program-1)
  - [3.2 Program execution daemonized](#32-program-execution-daemonized-1)
  - [3.3 Connect to the Unit use ROS](#33-connect-to-the-unit-use-ros-1)
  - [3.4 Check the status](#34-check-the-status-1)
- [4 Data format of communication data to the Unit](#4-data-format-of-communication-data-to-the-unit-1)
- [1. Connect to the Unit](#1-connect-to-the-unit-2)
  - [1.1 Connect to the Unit and PC](#11-connect-to-the-unit-and-pc-2)
  - [1.2 Connect to the Unit](#12-connect-to-the-unit-2)
- [2. Set up the Unit](#2-set-up-the-unit-2)
  - [2.1 Connect to Wireless LAN](#21-connect-to-wireless-lan-2)
  - [2.2 Set up the file of RSNP properties](#22-set-up-the-file-of-rsnp-properties-2)
- [3. Run action of the RSNP Unit](#3-run-action-of-the-rsnp-unit-2)
  - [3.1 Execution of RSNP communication program](#31-execution-of-rsnp-communication-program-2)
  - [3.2 Program execution daemonized](#32-program-execution-daemonized-2)
  - [3.3 Connect to the Unit use ROS](#33-connect-to-the-unit-use-ros-2)
  - [3.4 Check the status](#34-check-the-status-2)
- [4 Data format of communication data to the Unit](#4-data-format-of-communication-data-to-the-unit-2)
